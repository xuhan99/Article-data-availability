...
c('alpha11','alpha12','alpha21','alpha22','beta11','beta12','beta21','beta22','tau')


alpha11    <- parVals$alpha11                # a 60000*41 matrix
alpha12    <- parVals$alpha12                # a 60000*41 matrix
alpha21    <- parVals$alpha21                # a 60000*41 matrix
alpha22    <- parVals$alpha22                # a 60000*41 matrix
beta11     <- parVals$beta11                 # a 60000*41 matrix
beta12     <- parVals$beta12                 # a 60000*41 matrix
beta21     <- parVals$beta21                 # a 60000*41 matrix
beta22     <- parVals$beta22                 # a 60000*41 matrix
tau        <- parVals$tau                    # a 60000*41 matrix


writeMat('m4a_subwise_para(children).mat',
         alpha11=alpha11,
         alpha12=alpha12,
         alpha21=alpha21,
         alpha22=alpha22,
