...
int   choice[Ns, Ts];        //choice,1,2,3,4, choice is input as an integer.
...
parameters {
  ...
  vector[9] mu_pr; //mean of the parameters,2 paras: inequality aversion (guilt parameter) and a inverse temperature.
